<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="WebApplication.Pages.Admin.Orders" EnableViewState="false"%>
    ...
    <div class="outerContainer">
        <table id="ordersTable">
            ...
            <asp:Repeater ID="Repeater1" runat="server" SelectMethod="GetOrders"
                ItemType="WebApplication.Models.Order">
                <ItemTemplate>
                    <tr>
                        <td><%#: Item.Name %></td>
                        <td><%#: Item.City %></td>
